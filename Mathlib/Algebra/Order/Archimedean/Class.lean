...
@[to_additive ArchimedeanSubgroup.of_ne_top]
noncomputable
...
@[to_additive]
theorem lt_of_lt (hs : s ≠ ⊤) (ht : t ≠ ⊤) (hst : s < t) :
    MulArchimedeanSubgroup t < MulArchimedeanSubgroup s := by
  exact strictAntiOn _ (Set.mem_Iio.mpr hs.lt_top) (Set.mem_Iio.mpr ht.lt_top) hst

@[to_additive]
theorem le_of_le (hst : s ≤ t) : MulArchimedeanSubgroup t ≤ MulArchimedeanSubgroup s :=
  antitone _ hst
